...
(function () {
  ...
  const I18N = {
    EN: {
      ...
      disclaimer: '📋 All employee names, store data, financial figures, inventory records, and workforce schedules shown are entirely fictional and created for demonstration purposes only. No real company data, employee records, or internal systems were referenced.',
    ...
    FR: {
      ...
      disclaimer: '📋 Tous les noms d\'employés, données de magasin, chiffres financiers, registres d\'inventaire et horaires sont entièrement fictifs et créés uniquement à des fins de démonstration. Aucune donnée réelle d\'entreprise n\'a été utilisée.',
    ...
    ES: {
      ...
      disclaimer: '📋 Todos los nombres de empleados, datos de tienda, cifras financieras, registros de inventario y horarios son completamente ficticios y creados únicamente con fines de demostración. No se utilizaron datos reales de ninguna empresa.',
    ...
    '中': {
      ...
      inventoryTab: '库存管理',
      workforceTab: '人力排班',
      disclaimer: '📋 所有员工姓名、门店数据、财务数字、库存记录和排班信息均为虚构，仅为演示目的而创建。未引用任何真实公司数据、员工记录或内部系统。',
